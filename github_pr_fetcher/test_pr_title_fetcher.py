...
from github_pr_fetcher.pr_title_fetcher import HttpGitHubFetchPRGit, NotFoundException
...
class TestPRFetcher(unittest.TestCase):
    ...
    @patch(
        "github_pr_fetcher.pr_title_fetcher.HttpGitHubFetchPRGit.pr_query_url",
    ...
    def test_given_wrong_hhtp_address_when_reading_the_prs__then_it_should_fail(
        ...
        with self.assertRaises(NotFoundException):
            retuned_value = HttpGitHubFetchPRGit.get_github_pr_title()
        # Assert
