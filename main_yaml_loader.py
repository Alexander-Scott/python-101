...
if __name__ == "__main__":
    ...
    data_info = YamlLoader.read_file("yaml_loader/" + args.read_file_name)
    print(data_info)
    changed_job = YamlModify.yaml_modify(data_info, args.job_name)
    print(changed_job)
    YamlSaver.save_file(changed_job, "yaml_loader/" + args.write_file_name)
    print(YamlLoader.read_file("yaml_loader/" + args.write_file_name))
